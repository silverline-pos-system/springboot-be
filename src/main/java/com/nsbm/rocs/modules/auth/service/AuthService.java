...
import com.nsbm.rocs.modules.auth.dto.LogInResponseDTO;
import com.nsbm.rocs.modules.auth.dto.RegisterRequestDTO;
import com.nsbm.rocs.modules.auth.dto.RegisterResponseDTO;
...
import com.nsbm.rocs.modules.auth.repo.BranchRepo;
...
public class AuthService {
    ...
    private static final Pattern EMPLOYEE_ID_PATTERN = Pattern.compile("^EMP(\\d+)$");
    ...
    @Autowired
    public AuthService(UserProfileRepo userProfileRepo, BranchRepo branchRepo,
