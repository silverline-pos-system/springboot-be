...
import com.nsbm.rocs.modules.pos.dto.sale.CreateSaleRequest;
import com.nsbm.rocs.modules.pos.dto.sale.PaymentRequest;
import com.nsbm.rocs.modules.pos.dto.sale.SaleItemRequest;
import com.nsbm.rocs.modules.pos.dto.sale.SaleResponse;
import com.nsbm.rocs.modules.pos.dto.sale.SaleItemResponse;
import com.nsbm.rocs.modules.pos.dto.sale.PaymentResponse;
...
import com.nsbm.rocs.modules.pos.repository.PaymentRepository;
import com.nsbm.rocs.modules.pos.repository.SaleItemRepository;
...
import com.nsbm.rocs.modules.pos.repository.SalesReturnRepository;
import com.nsbm.rocs.modules.pos.repository.SalesReturnItemRepository;
import com.nsbm.rocs.modules.pos.dto.returns.ReturnRequest;
...
import com.nsbm.rocs.repository.SaasFeatureRepository;
...
public class PosService {
    ...
    private final com.nsbm.rocs.modules.inventory.repository.BatchRepository batchRepository;
    private final com.nsbm.rocs.shared.service.EmailService emailService;
    ...
    public PosService(SaleRepository saleRepository,
                      ...
                      com.nsbm.rocs.modules.inventory.repository.BatchRepository batchRepository,
                      com.nsbm.rocs.shared.service.EmailService emailService,
                    ...
                    if (!(soldItem.getProductId() == 332L || productName.toLowerCase().contains("service") || productName.toLowerCase().contains("dialog tv") || productName.toLowerCase().contains("dtv"))) {
                        ...
                        if (stockOpt.isPresent()) {
                            ...
                            if (soldItem.getBatchId() != null) {
                                java.util.Optional<com.nsbm.rocs.entity.inventory.Batch> batchOpt = batchRepository.findById(soldItem.getBatchId());
                                if (batchOpt.isPresent()) {
                                    com.nsbm.rocs.entity.inventory.Batch b = batchOpt.get();
    ...
    public com.nsbm.rocs.entity.pos.Customer createCustomer(com.nsbm.rocs.modules.pos.dto.customer.CreateCustomerRequest request) {
        // Validate
    ...
    public void requestLoyaltyRedemption(Long customerId, Integer pointsReq) {
        com.nsbm.rocs.entity.pos.Customer customer = customerRepository.findById(customerId)
