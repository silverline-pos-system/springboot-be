...
import com.nsbm.rocs.modules.inventory.dto.BatchDTO;
...
public class BatchService {
    ...
    /**
     * FEFO (First Expired, First Out) batch retrieval for dispatch form.
     * Returns non-expired batches with qty > 0, sorted by earliest expiry first.
     */
